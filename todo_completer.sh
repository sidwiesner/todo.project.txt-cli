...
_todo_sh()
{
  ...
  long_commands='add adda addx append archive del do edit go list listpri listall \
            prepend pri replace remdup report unwait wait waiting'
  short_commands='a app b ls lsp lsa  prep p pv uw w'
  options="-d -f -p -h -v -V"
